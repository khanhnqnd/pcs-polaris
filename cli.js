...
mySpawnPromisified('yarn', ['add', 'react@18.2.0'], { stdio: 'inherit' }).then(function (exitCode) {
  console.log('Installed react@18.2.0');
  console.log(`Exited with: ${exitCode}`);
});

mySpawnPromisified('yarn', ['add', 'react-dom@18.2.0'], { stdio: 'inherit' }).then(function (exitCode) {
